...
public class listSave extends ListActivity implements Runnable {

	private static String TAG = "ListSave";
	private static int LAYOUT = R.layout.listsave;
	private static int TOUCHPAD = R.id.listsave_footer;
	private static int CONSOLETEXT = R.id.listsave_text;
